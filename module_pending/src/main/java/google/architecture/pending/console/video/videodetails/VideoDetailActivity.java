...
//        activityVideoDetailBinding.setPosition(position);
        // ARouter
...
//        }
    ...
    private void subscribeToModel(final VideoDetailViewModel model) {
        //观察数据变化来刷新UI
        model.getLiveObservableData().observe(this, new Observer<List<VideoDetailData.EquipmentBean>>() {
            @Override
            public void onChanged(@Nullable List<VideoDetailData.EquipmentBean> videoDetailDataList) {
