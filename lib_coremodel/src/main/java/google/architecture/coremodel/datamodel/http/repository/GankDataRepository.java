...
public class GankDataRepository {
    ...
    public static Observable<GirlsData>  getFuliDataRepository(String size, String index){
        ...
        Observable<GirlsData> observableForGetFuliDataFromNetWork
                = ApiClient.getGankDataService().getFuliData(size,index);
    ...
    public static Observable<NewsData> getNewsDataRepository(String size, String index){
        ...
        Observable<NewsData> observableForGetAndroidDataFromNetWork
                = ApiClient.getGankDataService().getAndroidData(size,index);
